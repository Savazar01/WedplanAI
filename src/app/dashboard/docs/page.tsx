...
const getSections = (t: (key: string) => string) => [
  {
    ...
    items: [
      ...
      },
      {
        ...
        content:
          t("docs.sections.gettingStarted.items.sample.contentDashboard"),
      },
      {
        title: t("docs.sections.gettingStarted.items.wizard.title"),
        content:
          t("docs.sections.gettingStarted.items.wizard.contentDashboard"),
      },
      {
      ...
      },
      {
        ...
        content:
          t("docs.sections.gettingStarted.items.dashboard.contentDashboard"),
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        content:
          t("docs.sections.vendors.items.budget.contentDashboard"),
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        content:
          t("docs.sections.showcase.items.build.contentDashboard"),
      },
      {
  ...
  items: [
    {
      ...
      content:
        t("docs.sections.api.items.overview.contentDashboard"),
    },
    {
